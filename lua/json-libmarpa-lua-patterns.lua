-- usage: luajit json-libmarpa-lua-patterns.lua file
...
rhs[0] = S_false;
assert_result( C.marpa_g_rule_new (g, S_value, rhs, 1), "marpa_g_rule_new", g )
rhs[0] = S_null;
assert_result( C.marpa_g_rule_new (g, S_value, rhs, 1), "marpa_g_rule_new", g )
rhs[0] = S_true;
assert_result( C.marpa_g_rule_new (g, S_value, rhs, 1), "marpa_g_rule_new", g )
...
rhs[2] = S_end_array
assert_result( C.marpa_g_rule_new (g, S_array, rhs, 3), "marpa_g_rule_new", g )

rhs[0] = S_begin_object
rhs[1] = S_object_contents
rhs[2] = S_end_object
assert_result( C.marpa_g_rule_new (g, S_object, rhs, 3), "marpa_g_rule_new", g )
...
rhs[2] = S_value;
assert_result( C.marpa_g_rule_new (g, S_member, rhs, 3), "marpa_g_rule_new", g )

assert_result( C.marpa_g_start_symbol_set(g, S_value), "marpa_g_start_symbol_set", g )

assert_result( C.marpa_g_precompute(g), "marpa_g_precompute", g )

local r = ffi.gc( C.marpa_r_new(g), C.marpa_r_unref )
assert_result( r, "marpa_g_precompute", g )

assert_result( C.marpa_r_start_input(r), "marpa_r_start_input", g )
